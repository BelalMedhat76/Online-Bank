...
class Withdrawal extends React.Component {
 ...
 <div className="all">
            ...
            <div className="contact">
                <contact name="register" onsubmit="return test()" action="withdraw.html" />
                <div className="row1">
                    <div className="fname">
                ...
                <div className="row2">
                    <div className="Account_No">
                        <input type="text" name="acc" placeholder="  Account_No" /> 
                    </div>
                    <div className="Pass">
                ...
                <div className="row3">
                    <div className="money">
                    <input list="money"  placeholder="  chosse number of money" />
                        <datalist id="money">
                    ...
                    <div className="money2">
                        <input type="number" name="num" placeholder="  Enter Number you need" />
                    </div>
                </div>
