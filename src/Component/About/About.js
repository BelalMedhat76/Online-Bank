...
<img className="second-content-img" src={about} alt="Error" />
<div className="second-content-right" >
<p className="second-content-para1" className='p-color'>Relabile Online Payment Platform</p>
...
<p className="icon-inline" className='p-color'> Powerfull Online App For Bank</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
<i id="correct-icon" className="fas fa-check-circle"></i>
<p className="icon-inline" className='p-color'> Special For Multiple Use Capabilities</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
<i id="correct-icon" className="fas fa-check-circle"></i>
 <p className="icon-inline"  className='p-color'> Pring More Transparency</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
...
<p className="second-content-para2" className='para2-about' >Why choose Our World Fast Online</p>
<p className="second-content-para2" className='para2-about' style={{lineHeight:.5}}>Payment Services.</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
<i id="correct-icon" className="fas fa-anchor"></i>
<p className="icon-inline"  className='p-color'> Low Costing</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
<i id="correct-icon" className="fas fa-anchor"></i>
<p className="icon-inline"  className='p-color'> Save And Secure</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
<i id="correct-icon" className="fas fa-anchor"></i>
 <p className="icon-inline"  className='p-color'> Live Support</p>
<p className="para-correct-icon">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptates<br /> obcaecati neque voluptatibus eius in voluptatem asperiores quasi?<br /> Modi nihil eligendi distinctio neque aliquid nostrum quidem soluta</p>
